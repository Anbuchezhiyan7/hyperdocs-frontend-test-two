...
export const EditorContainer = ({
    ...
    return (
        <PlateContainer
            className={cn(
                'ignore-click-outside/toolbar slate-editor mt-[70px]',
    ...
    ),
    {
        ...
        variants: {
            ...
            variant: {
                ...
                demo: ' px-16 pt-4 pb-72 text-base sm:px-[max(64px,calc(50%-350px))]',
                fullWidth: 'size-full px-16 pt-4 pb-72 text-base sm:px-[max(64px,calc(50%-500px))]',
                none: '',
